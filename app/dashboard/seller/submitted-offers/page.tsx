          ...
          <CardContent className="flex items-start gap-3 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Your rank indicates your price position relative to other sellers. A rank of #1 means you have the lowest (most competitive) price. Ranks are updated in real-time as new offers are submitted.
              </p>
            </div>
          </CardContent>
        </Card>
